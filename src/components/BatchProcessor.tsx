      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-4">
          ...
          <div className="mt-4 flex flex-wrap items-center gap-4">
            ...
            <label className="inline-flex items-center gap-1.5 text-xs font-medium text-gray-700 dark:text-gray-200 cursor-pointer select-none focus-within:ring-2 focus-within:ring-brand-500 rounded px-1 py-0.5">
              <input
                type="checkbox"
                checked={strict}
                disabled={processing}
