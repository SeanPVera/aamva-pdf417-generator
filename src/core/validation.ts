 ...
 * shared table entry. Jurisdiction-defined subfile elements also carry their
 * own, because their codes only mean anything inside one jurisdiction and
 * putting them in the shared table would imply the standard defines them.
 */
