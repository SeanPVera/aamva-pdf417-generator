...
- [#270](https://github.com/SeanPVera/aamva-pdf417-generator/pull/270) [`4e29c77`](https://github.com/SeanPVera/aamva-pdf417-generator/commit/4e29c778e6aea8cfaba2c2b9de807fc08c99be56) Thanks [@SeanPVera](https://github.com/SeanPVera)! - Rebuild the application as an issuer-neutral record workbench with explicit import, structured editing, a PDF417 proof, and accessible diagnostic tabs.

  Repair address-jurisdiction and DL/ID semantics, whole-document undo, lossy repairs, malformed payload and import boundaries, asynchronous import races, render/export failure reporting, sensitive-history erasure, filename privacy, shared-origin cache cleanup, and local speech selection. Preserve opaque imported elements for inspection and JSON export; report regeneration limits explicitly.

  Add adversarial regression coverage, independent decoding of actual PNG downloads, responsive/keyboard/accessibility browser checks, and an engineering/design evidence report. Patch the development-only Vitest advisory. This release does not claim issuer certification or physical scan validation.
...
- [#271](https://github.com/SeanPVera/aamva-pdf417-generator/pull/271) [`21ab628`](https://github.com/SeanPVera/aamva-pdf417-generator/commit/21ab628e920c5fb3b76c7515e4726fefe5233e77) Thanks [@SeanPVera](https://github.com/SeanPVera)! - Stop demanding driving-privilege elements of an ID card on the older AAMVA editions, and correct Maine's field exclusions.
